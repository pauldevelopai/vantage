...
SCENE_PROMPT = (
    ...
    "Describe this camera frame in 2-3 clear, factual sentences. For PEOPLE: how "
    "many, what they wear, what they are doing, where in frame. For VEHICLES: "
    "colour, type/body, and make/model ONLY if clearly readable. Note any safety "
    "concern or unusual activity. Be factual and non-judgemental — describe what "
    "you see, never accuse. If the scene is empty, say so plainly."
)
